...
@section('content')
    ...
    <div class="container">
        <div class="mgb-40 padb-30 auto-invert line-b-4 align-center">
            <h1 class="font-cond-l fg-accent lts-md mgb-10" contenteditable="false">| -- Employee Information -- |</h1>
        ...
        <div class="center">
            <ul class="hash-list cols-3 cols-1-xs pad-30-all align-center text-sm">
                <li>
                    <p>Employee Image</p>
                    <img src="{{ asset($employee->img_path) }}" alt="I am A Pic" class="wpx-100 img-round mgb-20">
                    <div class="text">
