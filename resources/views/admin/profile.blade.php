...
<div class="container">
    <div class="mgb-40 padb-30 auto-invert line-b-4 align-center">
        <h1 class="font-cond-l fg-accent lts-md mgb-10" contenteditable="false" >𝐀𝐝𝐦𝐢𝐧 𝐏𝐫𝐨𝐟𝐢𝐥𝐞</h1>
        <h1 class="font-cond-b fg-text-d lts-md fs-300 fs-300-xs no-mg" contenteditable="false">𝒲𝑒𝓁𝒸𝑜𝓂𝑒 𝓉𝑜 𝒫𝑒𝓉 𝒞𝒶𝓇𝑒,
            <i style="color:rgb(101,109,74)"> {{ $admin->name }}</i>
    ...
    <div class="center">
        ...
        <ul class="hash-list cols-4 cols-2-xs pad-30-all align-center text-sm">
            <li>
                {{-- <p>Admin Image</p> --}}
                <img class="img" src="{{ asset('images/admin/' . $admin->img_path) }}" alt="I am A Pic"
                    alt="admin Profile" width="200" height="200">
              <br>
              <h5>═════════════════════════════════════════</h5>
                <span id="spam">𝐈𝐃: <i style="color:rgb(151, 81, 66)"> {{ $admin->id }}</i></span>
                <br>

                <span class="fs-110 font-cond-l " contenteditable="false">𝐉𝐨𝐛: <i style="color:rgb(151, 81, 66)">{{ $admin->job }}</i>
                </span>

                <br>
                <span id="spam">𝐔𝐬𝐞𝐫 𝐈𝐃: <i style="color:rgb(151, 81, 66)">{{ $admin->user_id }}</i></span>
